...
Run: cd viz/phase3 && python -m pytest api/tests/test_simulation_invariants.py -v
"""
...
from saturation_functions import (
...
class TestSaturationPatternMatching:
    ...
    def test_population_uses_non_negative_floor(self):
        ...
        from saturation_functions import floor_zero_saturation
