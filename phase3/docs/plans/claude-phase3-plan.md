...
All code lives in `viz/phase3/`. The `CLAUDE.md` in this directory has the full architecture, build commands, and file layout.
...
│   ├── services/simulation_service.py      # Bridges to v3.1 engine
│   └── config.py                           # Paths, CORS, timeouts
```

Backend simulation engine: `Global_Project/v3.1/simulation/`
